...
import com.seon.agora.common.service.RedisService;
import com.seon.agora.debate.dto.DebateSide;
import com.seon.agora.gemini.dto.PromptDiv;
import com.seon.agora.gemini.service.GeminiService;
...
import com.seon.agora.util.GeminiParser;
...
public class RoomServiceImpl implements RoomService {
    ...
    public void exitRoom(RoomExitRequest roomExitRequest, UserInfo userInfo) {
        ...
        if(room.getPro() == null && room.getCon() == null) {
            ...
            messagingTemplate.convertAndSend("/topic/room/" + room.getId()+"/state", new RoomStateResponse(room.getId(), RoomStatus.EXIT));
            //레디스에서 제거
